...
This page allows the user to enter the mock conference facilitator
--%>
...
<html>
    ...
    <body id="noScrollBackground">
        ...
        <br>
        <%--Adding icon below:--%>
        <img id="mockHomeImage" src="mock.jpg" />
        ...
        <form id="startMockButton" action="chooseCountries" method="POST">
            <input id="mockButtonTest" type="submit" value="START MOCK"/>
        </form>
        <br>
        <br>
        <br>
        ...
        <form id="resumeMockButton" action="rollCall" method="POST">
            <input id="mockButtonTest" type="submit" value="RESUME MOCK"/>
        </form>
        <br>
        <br>
        <br>
