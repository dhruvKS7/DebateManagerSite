...
This page displays the result of voting on motions
--%>
...
<html>
    ...
    <body id="noScrollBackground">
        ...
        <br>
        <%--Adding icon below:--%>
        <img id="motionImage1" src="scroll.png" />
        <img id="motionImage2" src="scroll.png" />
        <%--Creating header below:--%>
        <p id="announcementText">MOTION RESULTS</p>
        <br>
        <p id="motionTextFormat">MOTION: ${motionText}</p>
        <br>
        <p id="motionTextFormat">TOTAL TIME: ${timeText}</p>
        <br>
        <p id="motionTextFormat">SPEAKING TIME: ${speakText}</p>
        <br>
        <p id="motionTextFormat">PROPOSED BY: ${countryText}</p>
        <br>
        <%--Creating button to insert data into database below:--%>
        <form id="startAnnounceButton" action="mockProcedures" method="POST">
            <input id="mockButtonTest" type="submit" value="BACK"/>
        </form>
