...
This page displays the leadership members to admins and allows for extra management functions
--%>
...
<html>
    ...
    <body id="noScrollBackground">
        ...
        <br>
        <%--Adding icon below:--%>
        <img id="leadershipImage" src="DebateLeadershipIcon.png" />
        <%--Creating header below:--%>
        <p id="announcementText">LEADERSHIP</p>
        <%--Creating table to display data from database below:--%>
        <div id="leadershipAdminTable">
        ...
        <form name="nameEntry" id="updateLeaderButton" href="#popup1" method="POST">
            <a href="#popup1" id="entryButtonTest">UPDATE LEADER</a>
        </form>
        <br>
        <br>
        <br>
        ...
        <form name="nameEntry" id="addLeaderButton" href="#popup2" method="POST">
            <a href="#popup2" id="entryButtonTest">ADD LEADER</a>
        </form>
        <br>
        <br>
        <br>
        <br>
        <%--Creating button to insert data from database below:--%>
        <form name="nameEntry" id="deleteLeaderButton" href="#popup3" method="POST">
            <a href="#popup3" id="entryButtonTest">DELETE LEADER</a>
        </form>
            ...
            <div class="popup">
                ...
                <div class="content">
                    ...
                    <form action="updateLeader" method="POST">
                        ...
                        <br>
                        USERNAME: <br> <input type="text" name="leaderNameUpdate"/>
                        <br>
                        <br>
                        <hr class="updateLeft"> <p class="updatingText"> UPDATE </p> <hr class="updateRight">
                        <br>
                        FIRST NAME:<br> <input type="text" name="leaderFirstUpdate"/>
                        <br>
                        <br>
                        LAST NAME:<br> <input type="text" name="leaderLastUpdate"/>
                        <br>
                        <br>
                        LEADER POSITION:<br> <input type="text" name="leaderPositionUpdate"/>
                        <br>
                        <br>
            ...
            <div class="popup">
                ...
                <div class="content">
                    ...
                    <form action="registerAdmin" method="POST">
                        FIRST NAME: <br> <input type="text" name="adminFirstRegister"/>
                        <br>
                        <br>
                        LAST NAME: <br> <input type="text" name="adminLastRegister"/>
                        <br>
                        <br>
                        LEADER POSITION: <br> <input type="text" name="adminPositionRegister"/>
                        <br>
                        <br>
                        USERNAME: <br> <input type="text" name="adminNameRegister"/>
                        <br>
                        <br>
                        PASSWORD: <br> <input type="password" name="adminPasswordRegister"/>
                        <br>
                        <br>
                        <%--Creating button to send data to servlet below:--%>
            ...
            <div class="popup">
                ...
                <div class="content">
                    ...
                    <form action="deleteAdmin" method="POST">
                        USERNAME: <br> <input type="text" name="adminNameDelete"/>
                        <br>
                        <br>
                        <%--Creating button to send data to servlet below:--%>
