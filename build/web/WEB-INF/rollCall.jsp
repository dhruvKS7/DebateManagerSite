...
This page takes attendance for countries participating in the mock conference
--%>
...
<html>
    ...
    <body id="noScrollBackground">
        ...
        <p id="announcementText">ROLL CALL</p>
        <br>
        <br>
        <div id="countrySelectionBox">
            <form action="goToMockProcedures" id="chooseCountryButton" method="POST">
                <%--Creating table to display data from database below:--%>
                <div id="countries">
                    <div id="centeredTableTwo">
                        <table border="3" width="50%" id="tableTestTwo">
                            <tr>
                                <th>Country</th>
                            ...
                            <c:forEach var="row" items="${dbData}">
                                <tr id="column">
                                    ...
                                    <td id="statusColumn">
                                        <label class="container2">&nbsp;&nbsp;Present &nbsp;&nbsp;&nbsp;
                                            <input type="radio" value="present" name="${row.get(0)}">
                                            <span class="checkmark2"></span>
                                        </label>
                                        <label class="container3">&nbsp;&nbsp;Present & Voting &nbsp;&nbsp;
                                            <input type="radio" value="presentAndVoting" name="${row.get(0)}">
                                            <span class="checkmark3"></span>
                                        </label>
                                        <label class="container2">&nbsp;&nbsp;Absent 
                                            <input type="radio" value="absent" name="${row.get(0)}">
                                            <span class="checkmark2"></span>
                                        </label>
                                    </td>
                                </tr>
