...
This page displays the result of voting on working papers
--%>
...
<html>
    ...
    <body id="noScrollBackground">
        ...
        <br>
        <%--Adding icon below:--%>
        <img id="paperImage1" src="megaphone.png" />
        <img id="paperImage2" src="megaphone.png" />
        <%--Creating header below:--%>
        <p id="announcementText">PAPER RESULTS</p> <br> <br> <br> <br>
        <p id="paperText">PAPER: ${paperName}</p> <br>
        <p id="paperText">STATUS: ${paperStatus}</p> <br>
